...
export default function Signup() {
  ...
  const LOGIN_POST_URL = "http://localhost:8082/api/signup";
  const onSubmit = (data) => {
    console.log(data);
  ...
  return (
    ...
    >
      ...
      <div className="col-6">
        ...
        {errors.firstName && (
          <p className="text-danger muted">Please Valid First Name</p>
        )}
      </div>
      <div className="col-6">
        ...
        {errors.firstName && (
          <p className="text-danger muted">Please Valid Last Name</p>
        )}
      </div>
      ...
      <div className="col-12">
        ...
        {errors.emailId && (
          <p className="text-danger muted">Please enter valid email</p>
        )}
      </div>
      ...
      <div className="col-12">
        <button
          ...
          // onclick={alert("Login Password has been send to email")}
        >
          Sign Up
        </button>
      </div>
